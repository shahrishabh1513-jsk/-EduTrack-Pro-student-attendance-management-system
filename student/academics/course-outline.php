        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="course-card expanded" id="course1">
                <div class="course-header" onclick="toggleCourse('course1')">
                    <div class="course-header-left"><div class="course-icon"><i class="fas fa-code"></i></div><div><h3>Data Structures (CS301)</h3><p>4 Credits • Prof.Aakash Gupta</p></div></div>
            ...
            <div class="course-card" id="course3">
                <div class="course-header" onclick="toggleCourse('course3')">
                    <div class="course-header-left"><div class="course-icon"><i class="fas fa-globe"></i></div><div><h3>Web Development (CS303)</h3><p>3 Credits • Dr. Niraj Shah</p></div></div>
                    <div><i class="fas fa-chevron-down"></i></div>
                </div>
                <div class="course-body">

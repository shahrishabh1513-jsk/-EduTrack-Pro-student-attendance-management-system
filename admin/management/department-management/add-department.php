...
<head>
    ...
    <title>Add Department - EduTrack Pro</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-container { background: white; border-radius: 20px; padding: 30px; max-width: 700px; margin: 0 auto; }
...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content" id="mainContent">
            <header class="top-header">
                ...
                <div><h2>Add New Department</h2></div>
            ...
            <div class="form-container">
                <div class="form-title"><i class="fas fa-building"></i> Department Registration</div>
                <form id="addDepartmentForm">
                    <div class="form-row">
                        <div class="form-group"><label>Department Name *</label><input type="text" class="form-control" name="name" placeholder="e.g., Computer Science" required></div>
                        <div class="form-group"><label>Department Code *</label><input type="text" class="form-control" name="code" placeholder="e.g., CS" required></div>
                    </div>
                    <div class="form-row">
                        <div class="form-group"><label>Head of Department</label><input type="text" class="form-control" name="hod" placeholder="Full name of HOD"></div>
                        <div class="form-group"><label>Established Year</label><input type="text" class="form-control" name="established" placeholder="e.g., 2010"></div>
                    </div>
                    <div class="form-row">
                        <div class="form-group"><label>Email</label><input type="email" class="form-control" name="email" placeholder="department@edutrack.com"></div>
                        <div class="form-group"><label>Phone</label><input type="tel" class="form-control" name="phone" placeholder="Contact number"></div>
                    </div>
                    <div class="form-group"><label>Description</label><textarea class="form-control" name="description" rows="3" placeholder="Department description..."></textarea></div>
                    <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Create Department</button>
                    <button type="button" class="btn-cancel" onclick="window.location.href='departments.php'"><i class="fas fa-times"></i> Cancel</button>
                </form>
            </div>
        </main>
    </div>
    ...
    <script>
        document.getElementById('addDepartmentForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => window.location.href = 'departments.php', 1500);
        });

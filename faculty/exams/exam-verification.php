...
<body>
    ...
    <script>
        let applications = [
            { id: 1, student: 'Rishabh Shah', roll: 'IT181', class: 'CS301', className: 'Data Structures', subjects: ['CS301 - Data Structures', 'CS302 - Database Management', 'CS303 - Web Development', 'CS304 - Operating Systems', 'CS305 - Computer Networks'], fee: 3900, status: 'pending', appliedDate: '2024-03-15', paymentId: 'PAY123456', paymentStatus: 'Paid' },
            { id: 2, student: 'Jenish khunt', roll: 'IT095', class: 'CS301', className: 'Data Structures', subjects: ['CS301 - Data Structures', 'CS302 - Database Management', 'CS303 - Web Development', 'CS304 - Operating Systems', 'CS305 - Computer Networks'], fee: 3900, status: 'pending', appliedDate: '2024-03-16', paymentId: 'PAY123457', paymentStatus: 'Paid' },
            { id: 3, student: 'Vasu Motisarya', roll: 'IT124', class: 'CS301', className: 'Data Structures', subjects: ['CS301 - Data Structures', 'CS302 - Database Management', 'CS303 - Web Development', 'CS304 - Operating Systems', 'CS305 - Computer Networks'], fee: 3900, status: 'pending', appliedDate: '2024-03-14', paymentId: 'PAY123458', paymentStatus: 'Paid' },
            { id: 4, student: 'Hetvi Savani', roll: 'IT131', class: 'CS301', className: 'Data Structures', subjects: ['CS301 - Data Structures', 'CS302 - Database Management', 'CS303 - Web Development', 'CS304 - Operating Systems', 'CS305 - Computer Networks'], fee: 3900, status: 'verified', appliedDate: '2024-03-13', paymentId: 'PAY123459', paymentStatus: 'Paid', verifiedBy: 'Prof.Aakash Gupta', verifiedDate: '2024-03-14' },
